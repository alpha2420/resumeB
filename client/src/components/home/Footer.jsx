...
const Footer = () => {
    return (
        <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] mt-40" style={{ color: '#8B7355', background: 'linear-gradient(to right, #FEF9ED, #F5EFE0, #FEF9ED)' }}>
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <a href="#">
                        <img src="/logo.svg" alt="logo" className="h-11 w-auto" />
                    </a>
                    <div>
                        <p className="font-semibold" style={{ color: '#5D524B' }}>Product</p>
                        <ul className="mt-2 space-y-2">
                            <li><a href="/" className="hover:opacity-70 transition">Home</a></li>
                            <li><a href="/" className="hover:opacity-70 transition">Support</a></li>
                            <li><a href="/" className="hover:opacity-70 transition">Pricing</a></li>
                            <li><a href="/" className="hover:opacity-70 transition">Affiliate</a></li>
                        </ul>
                    </div>
                    <div>
                        <p className="font-semibold" style={{ color: '#5D524B' }}>Resources</p>
                        <ul className="mt-2 space-y-2">
                            <li><a href="/" className="hover:opacity-70 transition">Company</a></li>
                            <li><a href="/" className="hover:opacity-70 transition">Blogs</a></li>
                            <li><a href="/" className="hover:opacity-70 transition">Community</a></li>
                            <li><a href="/" className="hover:opacity-70 transition">Careers<span className="text-xs text-white rounded-md ml-2 px-2 py-1" style={{ backgroundColor: '#8B7355' }}>We're hiring!</span></a></li>
                            <li><a href="/" className="hover:opacity-70 transition">About</a></li>
                        </ul>
                    </div>
                    <div>
                        <p className="font-semibold" style={{ color: '#5D524B' }}>Legal</p>
                        <ul className="mt-2 space-y-2">
                            <li><a href="/" className="hover:opacity-70 transition">Privacy</a></li>
                            <li><a href="/" className="hover:opacity-70 transition">Terms</a></li>
                        </ul>
                    </div>
                </div>
